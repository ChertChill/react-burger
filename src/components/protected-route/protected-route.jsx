 ...
 * @param {boolean} props.requireAuth - Требуется ли авторизация для доступа к маршруту
 * @param {boolean} props.requireGuest - Требуется ли отсутствие авторизации для доступа к маршруту
 * @param {boolean} props.requireResetFlag - Требуется ли флаг доступа к reset-password
 * @param {string} props.redirectTo - Путь для редиректа (по умолчанию '/login' для защищенных маршрутов)
 */
...
ProtectedRoute.propTypes = {
    ...
    requireResetFlag: PropTypes.bool,
